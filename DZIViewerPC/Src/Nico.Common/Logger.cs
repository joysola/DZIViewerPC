...
namespace Nico.Common
{
    ...
    public static class Logger
    {
        ...
        static Logger()
        {
            ...
            fileInfo = File.Exists(curPath + "log4net.config") ? new FileInfo(Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "log4net.config")) : new FileInfo(Path.Combine(curPath, "log4net.config"));
            if (!fileInfo.Exists)
            {
