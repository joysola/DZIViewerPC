...
namespace Nico.DeepZoom
{
    ...
    public abstract class MultiScaleTileSource : DependencyObject
    {
        ...
        protected MultiScaleTileSource()
        {
        }
        ...
        protected void InitPar(long imageWidth, long imageHeight, int tileSize, int tileOverlap)
        {
            ImageSize = new Size(imageWidth, imageHeight);
            TileSize = tileSize;
            TileOverlap = tileOverlap;
        ...
        /// <summary>
        /// 当GetTileLayers返回值是null时调用
        /// </summary>
        /// <param name="tileLevel"></param>
        /// <param name="tilePositionX"></param>
        /// <param name="tilePositionY"></param>
        /// <returns></returns>
        protected internal virtual async Task<Stream> GetTileLayersAsync(int tileLevel, int tilePositionX, int tilePositionY) => await Task.FromResult<Stream>(null);
        
        protected internal virtual Task<MemoryStream> ReadImgStream(string url/*, int tileLevel, int tilePositionX, int tilePositionY*/) => null;
