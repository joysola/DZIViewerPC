...
{
    public class ScanCommonViewModel : CustomBaseViewModel
    {
        ...
        [Notification]
        public ScanQueryModel CurScanQuery { get; set; } = new ScanQueryModel() { cellType = "1"};
        ...
        public ScanCommonViewModel()
        {
            this.ProductDict = ExtendApiDict.Instance.ProductDict.Where(x => x.type == "1").ToList();
