...
namespace DST.Controls
{
    ...
    public partial class Pagination : UserControl
    {
        ...
        {
            get { return (string)GetValue(TotalNumProperty); }
        ...
        static Pagination()
        {
            ...
            TotalNumProperty = DependencyProperty.Register("TotalNum", typeof(string), typeof(Pagination), new PropertyMetadata(string.Empty, new PropertyChangedCallback(OnTotalNumChanged)));
        ...
        public static void OnTotalNumChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            Pagination p = d as Pagination;

            if (p != null)
            {
                Run rTotal = (Run)p.FindName("rTotalNum");
